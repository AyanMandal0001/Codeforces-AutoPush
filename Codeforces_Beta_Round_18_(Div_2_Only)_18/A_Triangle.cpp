...
bool right(ll x1,ll y1,ll x2,ll y2,ll x3,ll y3){
   vector<ll>v;
...
ll x1,y1,x2,y2,x3,y3;
 ...
 if(right(x1,y1,x2,y2,x3,y3)){
  ...
  for(ll i=0;i<4;i++){
    if(right(x1+dx[i],y1+dy[i],x2,y2,x3,y3) or 
       right(x1,y1,x2+dx[i],y2+dy[i],x3,y3)  or
       right(x1,y1,x2,y2,x3+dx[i],y3+dy[i])) {
            cout<<"ALMOST"<<endl;
          return;
       }  
  }
