...
//   cin >> n;
//   set<pair<ll,ll>>st;
//       // if n od (n+1)/2 up-down n/2 left-right
//       // if n od n/2 up-down (n+1)/2 left-right
//       // if n ev  n/2 up-down n/2 left-right
//      if(n&1){
//          // up-down first n/2   n/2+1
//         ll k1 = (n/2+1)*(n/2+2);
//          // left-right first n/2+1 n/2
//          ll k2 = (n/2+2)*(n/2+1);
//          cout << k1 + k2 << endl;
//      }
//      else{
